...
import { google } from 'google-maps'; // Replace with the appropriate way to import the Google Maps types
import { DirectionsService, DirectionsRenderer } from 'google-maps';
